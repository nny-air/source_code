...
policy_out <- readRDS("~/science-ynn-NMVOC/Policy_out.RDS")
...
#save Fig. 2
path = paste("~/science-ynn-NMVOC/Figs2/",'Fig_2',".png",sep='')
...
y.grob <- textGrob("log(NMVOC emissions)",
...
#save Fig. 3
path = paste("~/science-ynn-NMVOC/Figs2/",'Fig_3',".png",sep='')
...
#save Fig. 2 PDF
path = paste("~/science-ynn-NMVOC/Figs2/",'Fig_22',".pdf",sep='')
...
#save Fig. 3 PDF
path = paste("~/science-ynn-NMVOC/Figs2/",'Fig_32',".pdf",sep='')
