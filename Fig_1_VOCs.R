...
policy_out_filtered <- readRDS("~/science-ynn-NMVOC/Policy_out_filtered.RDS")
...
png("C:/Users/14329/Documents/science-ynn-NMVOC/Figs/Europe.png", width     = 10,height    = 10,units     = "in",res       = 800)
show(Europe)
dev.off() 

pdf("~/science-ynn-NMVOC/Figs/Europe.pdf", width     = 10,height    = 10)
show(Europe)
dev.off()

png("~/science-ynn-NMVOC/Figs/Asia_Oceania.png", width     = 10,height    = 10,units     = "in",res       = 800)
show(Asia_Oceania)
dev.off() 

pdf("~/science-ynn-NMVOC/Figs/Asia_Oceania.pdf", width     = 10,height    = 10)
show(Asia_Oceania)
dev.off() 

png("~/science-ynn-NMVOC/Figs/Americas.png", width     = 10,height    = 20,units     = "in",res       = 800)
show(Americas)
dev.off() 

pdf("~/science-ynn-NMVOC/Figs/Americas.pdf", width     = 10,height    = 20)
show(Americas)
dev.off() 

png("~/science-ynn-NMVOC/Figs/South_Africa.png", width     = 10,height    = 7,units     = "in",res       = 800)
show(South_Africa)
dev.off() 

pdf("~/science-ynn-NMVOC/Figs/South_Africa.pdf", width     = 10,height    = 7)
show(South_Africa)
dev.off()
...
for(c in unique(expanded_df$ISO)){
  ...
  path = paste("C:/Users/14329/Documents/science-ynn-NMVOC/Figs/Break_count_bar_charts_pdf",c,".pdf",sep="")
...
png("~/science-ynn-NMVOC/Figs/legend_break_map.png", width     = 20.00,height    = 5.00,units     = "in",res       = 800)
p
dev.off()
