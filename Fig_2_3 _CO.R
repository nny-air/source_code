...
policy_out <- readRDS("~/science-ynn-CO/Policy_out.RDS")
...
#save Fig. 2 #图片不清楚
path = paste("~/science-ynn-CO/Figs2/",'Fig_2',".png",sep='')
...
#save Fig. 3
path = paste("~/science-ynn-CO/Figs2/",'Fig_3',".png",sep='')
...
#save Fig. 2 PDF
path = paste("~/science-ynn-CO/Figs2/",'Fig_20',".pdf",sep='')
...
y.grob <- textGrob("log(CO emissions)",
                   gp=gpar(fontface="bold", fontsize=25), rot=90)
...
#save Fig. 3 PDF
path = paste("~/science-ynn-CO/Figs2/",'Fig_30',".pdf",sep='')
